                ...
                <div class="col-md-6 col-lg-7 col-xl-8">
                  <div class="chat-messages-container" style="height: 400px; overflow-y: auto; padding-right: 15px;">
                    ...
                    foreach ($messages as $row) {
                      ...
                      <!-- Message Bubble -->
                      <div
                        class="message-bubble d-flex <?php echo $isSender ? 'justify-content-end' : 'justify-content-start'; ?> mb-3">
                        <!-- Receiver action buttons -->
                        <?php if ($isSender): ?>
                          <div class="action-buttons">
                            <button type="button" class="btn-delete ms-auto" data-bs-toggle="modal"
                              data-bs-target="#deleteModal" data-message-id="<?php echo $row['messageID']; ?>">
