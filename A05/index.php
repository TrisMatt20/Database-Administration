                      ...
                      <ul class="list-unstyled mb-0">
                        <li class="p-2 border-bottom">
                          <a href="#!" class="d-flex justify-content-between">
                            <div class="d-flex flex-row">
                              <div>
                                <img src="assets/img/louie.png" alt="avatar" class="d-flex align-self-center me-3"
                                  width="60">
                        ...
                        <li class="p-2 border-bottom">
                          <a href="#!" class="d-flex justify-content-between">
                            <div class="d-flex flex-row">
                              <div>
                                <img src="assets/img/jade.png" alt="avatar" class="d-flex align-self-center me-3"
                                  width="60">
                    ...
                    foreach ($messages as $row) {
                      ...
                      <div class="d-flex <?php echo $isSender ? 'justify-content-end' : 'justify-content-start'; ?> mb-3">
                        ...
                        <div>
                          ...
                          <p class="small text-muted <?php echo $isSender ? 'text-end' : ''; ?>">9:45 AM | Oct 30</p>
                        </div>
                        <?php if ($isSender): ?>
                          <img src="<?php echo $profilePic; ?>" alt="avatar" style="width: 45px; height: 45px;"
                            class="ms-2">
